...
format_digest() {
  local title="$1"
  local lines endpoint_lines ci_lines tree_lines fleet_lines census_lines issue_lines
  ...
  # OMN-18949. Same reasoning as the heartbeats above: a section that prints
  # nothing when the probe did not run is indistinguishable from one printing
