...
Part of omninode_bridge - provides coordination I/O for ONEX nodes
"""
...
class MixinIntentPublisher:
    ...
    def _init_intent_publisher(self, container: ModelContainer) -> None:
        """
        ...
        if self._intent_kafka_client is None:
            raise ValueError(
                "MixinIntentPublisher requires 'kafka_client' service in container. "
