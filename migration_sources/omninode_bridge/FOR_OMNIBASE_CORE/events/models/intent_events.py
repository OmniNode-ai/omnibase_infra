"""
Intent event models for coordination I/O.

This module defines intent events used for coordination between nodes
without performing direct domain I/O. Intents are published to coordination
topics and executed by dedicated intent executor nodes.
