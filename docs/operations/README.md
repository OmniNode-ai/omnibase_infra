...
- Message Dispatch Engine — terminal correlator: migrated to the knowledge base, see [../architecture/MESSAGE_DISPATCH_ENGINE.md](../architecture/MESSAGE_DISPATCH_ENGINE.md)
