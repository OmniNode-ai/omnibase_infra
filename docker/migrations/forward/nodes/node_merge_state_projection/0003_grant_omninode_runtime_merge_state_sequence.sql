-- OMN-17447: sequence USAGE for omninode_runtime behind merge_state_transitions.projection_cursor.
...
-- ============================================================================
--   `0001_create_merge_state_transitions.sql` declares
--   `projection_cursor BIGSERIAL PRIMARY KEY`. PostgreSQL rewrites that into a plain
...
--   SELECT/INSERT/UPDATE grant on `merge_state_transitions` and STILL fail
...
--   `merge_state_transitions` sitting at ZERO ROWS, for this reason.
--
-- ============================================================================
