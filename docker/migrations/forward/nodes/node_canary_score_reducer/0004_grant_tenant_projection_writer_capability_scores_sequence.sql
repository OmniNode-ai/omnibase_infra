-- OMN-17447: sequence USAGE for tenant_projection_writer behind capability_scores.id.
-- Target DB: omnidash_analytics (NODE_POSTGRES_DB)
-- Node: node_canary_score_reducer
--
-- ============================================================================
-- THE HALF A TABLE GRANT DOES NOT REACH
-- ============================================================================
--   `0001_create_capability_scores.sql` declares
...
--   SELECT/INSERT/UPDATE grant on `capability_scores` and STILL fail
