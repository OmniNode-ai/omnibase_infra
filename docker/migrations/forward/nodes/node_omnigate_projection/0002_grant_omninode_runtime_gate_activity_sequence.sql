-- OMN-17447: sequence USAGE for omninode_runtime behind gate_activity.id.
...
-- ============================================================================
--   `0000_create_gate_projection_tables.sql` declares
...
--   SELECT/INSERT/UPDATE grant on `gate_activity` and STILL fail
