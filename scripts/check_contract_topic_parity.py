...
_LEGACY_ALLOWLIST: dict[str, str] = {
    ...
    "onex.evt.omnibase-infra.delegation-completed.v2": "delegation V2 terminal; contract source remains in omnimarket until the cross-repo contract migration | owner: jonah | expiry: 2026-09-14",
    "onex.evt.omnibase-infra.delegation-failed-routed.v2": "delegation V2 terminal; contract source remains in omnimarket until the cross-repo contract migration | owner: jonah | expiry: 2026-09-14",
    "onex.evt.omnibase-infra.delegation-failed-unrouted.v2": "delegation V2 terminal; contract source remains in omnimarket until the cross-repo contract migration | owner: jonah | expiry: 2026-09-14",
