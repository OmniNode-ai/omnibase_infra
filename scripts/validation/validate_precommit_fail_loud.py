...
(OMN-14667, WS7 fan-out #3 of the OMN-14655 canary; ported byte-for-byte from
omnimarket#1783 / omniclaude#1904 so every surface enforces the identical rule).
...
own docstring when a hook `entry:` resolves this file directly (omnibase_infra
