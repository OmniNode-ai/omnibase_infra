...
"""Stub handler for registry API operation: list_instances.
...
class HandlerRegistryApiListInstances:
    """Stub handler for operation: list_instances.

    Lists live service instances from Consul.
    ...
    async def handle(self, request: object, correlation_id: UUID) -> object:
        ...
        raise NotImplementedError(
            "HandlerRegistryApiListInstances is not yet implemented. "
