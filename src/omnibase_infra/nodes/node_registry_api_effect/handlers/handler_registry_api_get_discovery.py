...
"""Stub handler for registry API operation: get_discovery.
...
class HandlerRegistryApiGetDiscovery:
    """Stub handler for operation: get_discovery.

    Returns full dashboard payload combining nodes, instances, and widget mapping.
    ...
    async def handle(self, request: object, correlation_id: UUID) -> object:
        ...
        raise NotImplementedError(
            "HandlerRegistryApiGetDiscovery is not yet implemented. "
