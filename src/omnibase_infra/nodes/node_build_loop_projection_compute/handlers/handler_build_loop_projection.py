...
class HandlerBuildLoopProjection:
    ...
    async def handle(
        ...
        """Canonical def-B dispatch entrypoint (OMN-14821).
        ...
        direct dict/object call in a unit test. This projects the terminal event
        into a ``build_loop.append`` intent for ``NodeBuildLoopWriteEffect`` to
        persist.
        """
