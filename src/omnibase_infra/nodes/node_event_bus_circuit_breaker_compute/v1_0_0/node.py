...
from .models.model_event_bus_circuit_breaker_output import ModelEventBusCircuitBreakerOutput
...
class NodeEventBusCircuitBreakerCompute(NodeComputeService[ModelEventBusCircuitBreakerInput, ModelEventBusCircuitBreakerOutput]):
    ...
    def __init__(self, container: ModelONEXContainer):
        ...
        self._config: Optional[ModelCircuitBreakerConfig] = None
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise OnexError(
                ...
                message=f"Failed to initialize circuit breaker compute node: {str(e)}"
            ) from e
