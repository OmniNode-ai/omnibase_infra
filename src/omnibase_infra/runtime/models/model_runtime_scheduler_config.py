...
Environment Variables:
    ...
    Valkey (Redis-compatible) Settings:
        ...
        RUNTIME_SCHEDULER_VALKEY_TIMEOUT: Timeout for Valkey ops (float)
            Default: 5.0 seconds
            Range: 0.1-60.0

        RUNTIME_SCHEDULER_VALKEY_RETRIES: Connection retries (integer)
            Default: 3
            Range: 0-10
...
class ModelRuntimeSchedulerConfig(BaseModel):
    ...
    def apply_environment_overrides(self) -> ModelRuntimeSchedulerConfig:
        ...
        env_mappings: dict[str, str] = {
            ...
            "RUNTIME_SCHEDULER_VALKEY_TIMEOUT": "valkey_timeout_seconds",
            "RUNTIME_SCHEDULER_VALKEY_RETRIES": "valkey_connection_retries",
        }
