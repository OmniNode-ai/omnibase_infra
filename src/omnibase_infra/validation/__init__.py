...
Security Design (Intentional Fail-Open Architecture):
    ...
    **Security Responsibility Boundaries**:
    ...
    - validator_runtime_shape.py: Runtime validation (Security Design section, lines 52-121)
...
# convenience. See validator_execution_shape.py lines 112-149 for the definition.
...
# (not a separate definition). See validator_runtime_shape.py lines 193-196 for the import.
