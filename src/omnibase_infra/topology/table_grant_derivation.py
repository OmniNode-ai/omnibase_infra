...
LEGACY_MIGRATION_TABLE_DECLARATIONS: tuple[ContractTableDeclaration, ...] = (
    ...
    # OMN-18900 dod_verify_runs entry that sat here, retired by
    # omnimarket#2722 merging and the pin advancing past it: the migration
    # that creates this relation is
