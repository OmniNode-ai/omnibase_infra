...
class ModelOmniNodeTopicSpec(BaseModel):
    ...
    @classmethod
    def for_postgres_query_completed(cls, correlation_id: str | None = None) -> "ModelOmniNodeTopicSpec":
    ...
    @classmethod
    def for_postgres_query_failed(cls, correlation_id: str | None = None) -> "ModelOmniNodeTopicSpec":
