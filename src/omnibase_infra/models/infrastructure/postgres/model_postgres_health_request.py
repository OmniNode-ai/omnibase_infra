...
class ModelPostgresHealthRequest(BaseModel):
    ...
    include_connection_stats: bool = Field(
        default=True, description="Include connection pool statistics",
    )
    include_schema_info: bool = Field(
        default=True, description="Include schema validation information",
    )
