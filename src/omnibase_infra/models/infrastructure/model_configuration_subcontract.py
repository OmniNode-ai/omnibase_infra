...
class ModelValidationRule(BaseModel):
    ...
    @classmethod
    def validate_range_values(cls, v: Optional[float], info) -> Optional[float]:
    ...
    @classmethod
    def validate_allowed_values(cls, v: Optional[List[str]], info) -> Optional[List[str]]:
...
class ModelConfigurationSubcontract(BaseModel):
    ...
    environment_config: Optional[ModelEnvironmentConfiguration] = Field(
        default=None,
        description="Environment variable configuration"
    )
    
    validation_config: Optional[ModelConfigurationValidation] = Field(
        default=None,
