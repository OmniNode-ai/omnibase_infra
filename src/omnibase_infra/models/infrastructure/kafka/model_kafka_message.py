...
from omnibase_infra.models.infrastructure.kafka.model_kafka_message_payload import (
    KafkaMessagePayload,
)
...
class ModelKafkaMessage(BaseModel):
    ...
    key: str | bytes | None = Field(
        default=None, description="Message key for partitioning",
    )
    value: KafkaMessagePayload = Field(
        description="Message payload with strongly typed structure",
    )
    ...
    partition: int | None = Field(
        default=None, description="Target partition (if specified)",
    )
    ...
    correlation_id: UUID | None = Field(
        default=None, description="Message correlation ID",
    )
    message_id: str | None = Field(
        default=None, description="Unique message identifier",
    )
    schema_version: str | None = Field(
        default=None, description="Message schema version",
    )
    compression_type: str | None = Field(
        default=None, description="Message compression type",
    )
