...
class ModelKafkaTopicOverrides(BaseModel):
    ...
    segment_bytes: int | None = Field(
        default=None,
        description="Log segment size in bytes",
    )
    segment_jitter_ms: int | None = Field(
        default=None,
    ...
    message_format_version: str | None = Field(
        default=None,
        description="Message format version",
    )
    message_timestamp_type: str | None = Field(
        default=None,
        description="Message timestamp type (CreateTime or LogAppendTime)",
    )
    message_timestamp_difference_max_ms: int | None = Field(
        default=None,
