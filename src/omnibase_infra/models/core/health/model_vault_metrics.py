...
class ModelVaultMetrics(BaseModel):
    ...
    certificates_issued_total: int | None = Field(
        default=None,
        ge=0,
        description="Total number of certificates issued",
    )

    certificates_revoked_total: int | None = Field(
        default=None,
        ge=0,
    ...
    encryption_operations_per_second: float | None = Field(
        default=None,
        ge=0.0,
        description="Encryption operations per second",
    )

    decryption_operations_per_second: float | None = Field(
        default=None,
        ge=0.0,
