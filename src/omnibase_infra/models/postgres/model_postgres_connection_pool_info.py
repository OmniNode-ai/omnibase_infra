...
class ModelPostgresConnectionPoolInfo(BaseModel):
    ...
    pool_name: Optional[str] = Field(default=None, description="Name of the connection pool")
    average_connection_time_ms: Optional[float] = Field(default=None, description="Average connection time in milliseconds", ge=0)
