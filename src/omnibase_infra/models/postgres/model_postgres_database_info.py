...
class ModelPostgresDatabaseInfo(BaseModel):
    ...
    database_size_bytes: int | None = Field(default=None, description="Database size in bytes", ge=0)
    ...
    uptime_seconds: int | None = Field(default=None, description="Database uptime in seconds", ge=0)
