...
class ModelSecurityEventDetails(BaseModel):
    ...
    # Event context
    resource_accessed: str | None = Field(default=None, description="Resource that was accessed")
    action_attempted: str | None = Field(default=None, description="Action that was attempted")
...
class ModelSecurityEventMetadata(BaseModel):
    ...
    service_name: str | None = Field(default=None, description="Service that generated the event")
    service_version: str | None = Field(default=None, description="Service version")

    # Security context
    security_level: str | None = Field(default=None, description="Security level classification")
...
class ModelAuditLogEntry(BaseModel):
    ...
    metadata: ModelSecurityEventMetadata | None = Field(default=None, description="Event metadata")
    ...
    previous_hash: str | None = Field(default=None, description="Previous entry hash for chain verification")
