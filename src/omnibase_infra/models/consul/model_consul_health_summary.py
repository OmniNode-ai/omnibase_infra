...
class ModelConsulHealthSummary(BaseModel):
    ...
    overall_status: ModelConsulServiceStatus = Field(..., description="Overall health status")
    ...
    services: list[ModelConsulServiceInfo] = Field(default_factory=list, description="List of services with health information")
