...
class ModelKafkaAdapterInput(BaseModel):
    ...
    message: ModelKafkaMessage | None = Field(
        default=None,
        description="Kafka message payload (for produce operations)",
    )
    topic_config: ModelKafkaTopicConfig | None = Field(
        default=None,
        description="Topic configuration (for topic operations)",
    )
    producer_config: ModelKafkaProducerConfig | None = Field(
        default=None,
        description="Producer configuration (for produce operations)",
    )
    consumer_config: ModelKafkaConsumerConfig | None = Field(
        default=None,
