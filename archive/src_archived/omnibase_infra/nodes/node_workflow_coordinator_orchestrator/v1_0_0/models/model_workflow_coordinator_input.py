...
from omnibase_infra.models.workflow.model_workflow_execution_request import (
...
class ModelWorkflowCoordinatorInput(ModelBase):
    ...
    workflow_request: ModelWorkflowExecutionRequest | None = Field(
        None, description="Workflow execution request data",
    )
    workflow_id: UUID | None = Field(
        None, description="Workflow ID for status operations",
    )
