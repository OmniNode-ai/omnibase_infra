...
from .postgres_connection_manager import (
...
class InfrastructureHealthMonitor:
    ...
    def __init__(self, environment: str | None = None):
        ...
        self._postgres_manager: PostgresConnectionManager | None = None
        self._kafka_pool: KafkaProducerPool | None = None
        self._circuit_breaker: EventBusCircuitBreaker | None = None
    ...
    def _determine_overall_health(
        ...
        if postgres_healthy and (kafka_healthy or circuit_breaker_healthy):
            return "degraded"
...
_health_monitor: InfrastructureHealthMonitor | None = None


def get_health_monitor(environment: str | None = None) -> InfrastructureHealthMonitor:
