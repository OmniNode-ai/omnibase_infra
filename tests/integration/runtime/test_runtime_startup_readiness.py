...
def _get_aiohttp_bound_port(health_server: ServiceHealth) -> int:
    ...
    try:
        ...
        msg = (
            ...
            f"{aiohttp.__version__}, verified against 3.13.3). "
