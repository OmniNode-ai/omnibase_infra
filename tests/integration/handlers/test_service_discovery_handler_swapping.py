...
class BaseHandlerSwappingTests:
    ...
    @pytest.fixture
    def handler(self) -> ProtocolHandlerServiceDiscovery:
    ...
    async def test_handler_conforms_to_protocol(
        ...
        """Handler is an instance of ProtocolHandlerServiceDiscovery."""
        assert isinstance(handler, ProtocolHandlerServiceDiscovery), (
            f"{type(handler).__name__} must implement ProtocolHandlerServiceDiscovery"
        )
...
class TestHandlerFactoryPattern:
    ...
    def create_handler_by_type(
        ...
        Returns:
            Handler instance implementing ProtocolHandlerServiceDiscovery
...
class TestRuntimeHandlerSwapping:
    ...
    async def test_swap_handler_mid_operation(self) -> None:
        ...
        current_handler: ProtocolHandlerServiceDiscovery = HandlerServiceDiscoveryMock()
...
class TestConsulHandlerSwapping(BaseHandlerSwappingTests):
    ...
    async def handler(
        self,
    ) -> AsyncGenerator[ProtocolHandlerServiceDiscovery, None]:
