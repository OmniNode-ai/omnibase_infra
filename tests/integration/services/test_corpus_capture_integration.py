...
"""
Integration tests for CorpusCaptureEngine with ManifestGenerator.

Tests the full pipeline integration: ManifestGenerator callback -> CorpusCaptureEngine.
...
class TestManifestGeneratorIntegration:
    ...
    def test_callback_on_init(self) -> None:
        """CorpusCaptureEngine can be registered as callback in ManifestGenerator __init__."""
        ...
        capture_service = CorpusCaptureEngine()
    ...
    def test_callback_registered_dynamically(self) -> None:
        """CorpusCaptureEngine can be registered dynamically via register_on_build_callback."""
        # Setup capture service
        config = ModelCaptureConfig(
