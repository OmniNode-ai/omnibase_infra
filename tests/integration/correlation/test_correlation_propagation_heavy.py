...
class TestCorrelationDatabase:
    ...
    async def test_correlation_preserved_on_db_operation(
        ...
        pytest.skip(
            "[OMN-1349] Requires real PostgreSQL - implement when db fixtures available"
        )
...
class TestCorrelationKafka:
    ...
    async def test_correlation_end_to_end_with_real_kafka(
        ...
        pytest.skip(
            "[OMN-1349] Requires real Kafka/Redpanda - implement when event bus fixtures available"
        )
