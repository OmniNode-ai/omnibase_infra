...
class TestModelReplayConfigBootstrapServersValidation:
    ...
    def test_valid_server_with_ip(self) -> None:
        ...
        config = ModelReplayConfig(
            bootstrap_servers="192.168.1.100:19092"  # kafka-fallback-ok — testing IP validation logic
        )
        assert config.bootstrap_servers == "192.168.1.100:19092"  # kafka-fallback-ok
