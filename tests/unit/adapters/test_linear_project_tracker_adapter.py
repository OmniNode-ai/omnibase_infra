...
"""Tests for AdapterProjectTrackerLinear.
...
@pytest.mark.unit
class TestAdapterProjectTrackerLinearLifecycle:
...
@pytest.mark.unit
class TestAdapterProjectTrackerLinearIssues:
    def test_get_issue_delegates_to_mcp(self) -> None:
        fake = MagicMock(return_value=_FAKE_ISSUE)
        adapter = AdapterProjectTrackerLinear(mcp_get_issue=fake)
    ...
    def test_list_issues_with_filters_and_limit(self) -> None:
        ...
        adapter = AdapterProjectTrackerLinear(mcp_list_issues=fake)
    ...
    def test_create_issue_forwards_kwargs(self) -> None:
        fake = MagicMock(return_value=_FAKE_ISSUE)
        adapter = AdapterProjectTrackerLinear(mcp_create_issue=fake)
    ...
    def test_update_issue_delegates(self) -> None:
        fake = MagicMock(return_value=_FAKE_ISSUE)
        adapter = AdapterProjectTrackerLinear(mcp_update_issue=fake)
    ...
    def test_search_issues_delegates(self) -> None:
        fake = MagicMock(return_value=[_FAKE_ISSUE])
        adapter = AdapterProjectTrackerLinear(mcp_search_issues=fake)
...
@pytest.mark.unit
class TestAdapterProjectTrackerLinearComments:
    def test_add_comment_delegates(self) -> None:
        ...
        adapter = AdapterProjectTrackerLinear(mcp_add_comment=fake)
...
@pytest.mark.unit
class TestAdapterProjectTrackerLinearProjects:
    def test_get_project_delegates(self) -> None:
        ...
        adapter = AdapterProjectTrackerLinear(mcp_get_project=fake)
    ...
    def test_list_projects_delegates(self) -> None:
        ...
        adapter = AdapterProjectTrackerLinear(mcp_list_projects=fake)
