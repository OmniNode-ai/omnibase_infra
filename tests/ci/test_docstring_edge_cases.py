...
class TestDocstringDetectionEdgeCases:
    ...
    def forbidden_patterns(self) -> list[str]:
        """Standard forbidden pattern for testing."""
        return ["kafka"]
    ...
    def test_basic_import_detected(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_from_import_detected(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_import_in_comment_skipped(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_raw_string_multiline_skipped(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_fstring_multiline_skipped(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_bytes_multiline_skipped(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_multiple_docstrings_handled(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_empty_docstring_handled(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_nested_class_docstring(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_docstring_with_code_example(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_complex_mixed_quotes_pattern(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_single_line_string_with_other_delimiter_inside(
        self, forbidden_patterns: list[str]
    ) -> None:
        """Single-line string with the other delimiter type inside.
...
class TestDocstringDetectionRobustness:
    ...
    def test_unicode_in_docstring(self, forbidden_patterns: list[str]) -> None:
    ...
    def test_very_long_docstring(self, forbidden_patterns: list[str]) -> None:
