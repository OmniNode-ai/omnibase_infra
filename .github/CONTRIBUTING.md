...
The knowledge bases provide explanations and examples (see the Documentation section of the root [README.md](../README.md)), but **CLAUDE.md rules take precedence** when there is any conflict.
